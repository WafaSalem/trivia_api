...
def create_app(test_config=None):
  ...
  '''
    def paginate_question(request, selection):
        ...
        questions = [page.format() for page in selection]
    ...
    def get_question():
        ...
        question = paginate_question(request, selection)
        ...
        for catogry in categories:
            data[catogry.id] = catogry.type

        return jsonify({
            'success': True,
            'questions': question,
            'number-of-questions': len(selection),
            'categories': data
        })
  ...
  '''
    ...
    def retrive_question(category_id):
        try:
